...
var Backdrop = function (_Component) {
    ...
    createClass(Backdrop, [{
        key: 'render',
        value: function render() {
            return React__default.createElement('rect', { name: 'backdrop', className: 'backdrop', fill: this.props.theme.backdropFill,
    ...
    createClass(XAxis, [{
        ...
        value: function render() {
            ...
            for (var t = 0; t < Store.getMeasures().countX; t++) {
                ...
                ticks.push(React__default.createElement('line', { className: long ? 'longtick' : 'tick', key: 'tick-' + t, x1: x, y1: y1, x2: x, y2: y2, stroke: this.props.theme.axisColor }));
