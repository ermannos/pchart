...
var Backdrop = function (_Component) {
    inherits(Backdrop, _Component);

    function Backdrop() {
        classCallCheck(this, Backdrop);
        return possibleConstructorReturn(this, (Backdrop.__proto__ || Object.getPrototypeOf(Backdrop)).apply(this, arguments));
    }

    createClass(Backdrop, [{
        key: 'render',
        value: function render() {
            return React__default.createElement('rect', { name: 'backdrop', className: 'backdrop',
...
var XAxis = function (_Component) {
    ...
    function XAxis() {
        ...
        return possibleConstructorReturn(this, (XAxis.__proto__ || Object.getPrototypeOf(XAxis)).apply(this, arguments));
    }
    ...
    createClass(XAxis, [{
        ...
        value: function render() {
            ...
            for (var t = 0; t < Store.getMeasures().countX; t++) {
                ...
                ticks.push(React__default.createElement('line', { className: long ? 'longtick' : 'tick', key: 'tick-' + t, x1: x, y1: y1, x2: x, y2: y2 }));
    ...
    createClass(YAxis, [{
        ...
        value: function render() {
            ...
            for (var t = 0; t <= tickcount; t++) {
                ...
                ticks.push(React__default.createElement('line', { className: long ? 'longtick' : 'tick', key: 'tick-' + t, x1: x1, y1: y, x2: x2, y2: y }));
    ...
    createClass(Grid, [{
        ...
        value: function render() {
            ...
            for (var t = 0; t < tickcountX; t++) {
                ...
                reflinesx.push(React__default.createElement('line', { className: long ? 'longrefline' : 'refline', key: 'reflinex-' + t, x1: x, y1: y1, x2: x, y2: y2 }));
            }
            ...
            for (var _t = 0; _t <= tickCountY; _t++) {
                ...
                reflinesy.push(React__default.createElement('line', { className: _long ? 'longrefline' : 'refline', key: 'refliney-' + _t, x1: x1, y1: y, x2: x2, y2: y }));
            }
            return React__default.createElement(
                'g',
...
var Areas = function (_Component) {
    ...
    createClass(Areas, [{
        ...
        value: function render() {
            ...
            pathStr += 'Z';
            areas.push(React__default.createElement('path', { className: 'area-curve', key: 'area-curve-1', name: 'area-curve-1', d: pathStr }));
            ...
            if (Store.getDataset().percentiles.length >= 4) {
                ...
                pathStr += 'Z';
                areas.push(React__default.createElement('path', { className: 'area-curve', key: 'area-curve-2', name: 'area-curve-2', d: pathStr }));
            }
    ...
    createClass(PatientData, [{
        ...
        value: function render() {
            ...
            return React__default.createElement(
                ...
                React__default.createElement('path', { className: 'percentile-line', d: lineStr, stroke: this.props.patient.color || 'red' }),
                labels,
                points
            );
        }
    ...
    createClass(PChart, [{
        ...
        value: function render() {
            ...
            patients.forEach(function (patient, i) {
                patientdata.push(React__default.createElement(PatientData, { key: 'patientdata-' + i, patient: patient, showlabels: _this2.props.showlabels }));
            });

            return React__default.createElement(
                'svg',
                { width: Store.getSize().width, height: Store.getSize().height },
                title,
                React__default.createElement(Backdrop, null),
                React__default.createElement(XAxis, null),
                React__default.createElement(YAxis, null),
                React__default.createElement(Grid, null),
                React__default.createElement(Areas, null),
